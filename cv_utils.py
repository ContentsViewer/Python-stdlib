...
def get_distance_lines(line_a, line_b):
    """Get all possible distances between each dot of two lines and second line
        return the shortest
    """
    dist1 = get_distance_point_line(line_a[:2], line_b)
    dist2 = get_distance_point_line(line_a[2:], line_b)
    dist3 = get_distance_point_line(line_b[:2], line_a)
    dist4 = get_distance_point_line(line_b[2:], line_a)
...
def get_centers(contours):
    ...
    for idx, cnt in enumerate(contours):
        m = cv2.moments(cnt)
        centers[idx][0] = int(m['m10'] / m['m00'])
        centers[idx][1] = int(m['m01'] / m['m00'])
